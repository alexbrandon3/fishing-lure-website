...
export default function Contact() {
  ...
  return (
    <div className="container auto flex place-items-center items-left flex-col my-14">
      ...
      <div
        className="flex items-center my-4 p-2 rounded-lg bg-gray-300 cursor-pointer mailto w-1/4 hover:bg-gray-700 hover:text-white"
        onClick={emailClick}
      >
        <button>
          <img
      ...
      <div
        className="flex items-center my-4 p-2 rounded-lg bg-gray-300 cursor-pointer w-1/4 hover:bg-gray-700 hover:text-white"
        onClick={githubClick}
      >
        <button className="" href="https://github.com/alexbrandon3">
          {" "}
          <img className="h-10 w-10" src={githubIcon} alt="github icon"></img>
        </button>
      ...
      >
        <button
          className=""
          href="https://linkedin.com/in/alex-brandon-ab6045214"
        >
          {" "}
          <img className="h-10 w-10" src={linkedInIcon} alt="github icon"></img>
        </button>
